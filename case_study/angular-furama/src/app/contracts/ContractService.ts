...
export class ContractService {
  ...
  public findById(id: number): Observable<Contract> {
  ...
  public save(contract: Contract): Observable<Contract> {
    ...
    if (contract.id === undefined) {
      ...
      return this.http.patch<Contract>(`${API_URL}/contracts/${contract.id}`, contract);
    }
  }

  public delete(contract: Contract): Observable<Contract> {
    return this.http.delete<Contract>(`${API_URL}/contracts/${contract.id}`);
